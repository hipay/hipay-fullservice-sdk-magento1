...
# Change the clause FROM
sed -i -e "s/FROM php:5.6-apache/FROM mindk/php5.3.29-apache/" bin/docker/php5-4/Dockerfile
sed -i -e "s/PHP_VERSION=5.3/PHP_VERSION=5.3/" bin/docker/php5-4/Dockerfile

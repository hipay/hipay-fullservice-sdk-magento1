...
casper.test.begin('Functions Checkout', function (test) {
    ...
    casper.fillStepPayment = function () {
        ...
        this.waitUntilVisible('#checkout-step-payment', function success() {
            ...
            if (currentBrandCC == 'visa')
                this.fillFormMagentoCreditCard(cardsType.visa, cardsNumber.visa, "500");
            else if (currentBrandCC == 'cb' || currentBrandCC == "mastercard")
                this.fillFormMagentoCreditCard(cardsType.cb, cardsNumber.cb, "500");
            else if (currentBrandCC == 'amex')
                this.fillFormMagentoCreditCard(cardsType.amex, cardsNumber.amex, "500");
            else if (currentBrandCC == 'visa_3ds')
                this.fillFormMagentoCreditCard(cardsType.visa, cardsNumber.visa_3ds, "500");
            else if (currentBrandCC == 'maestro')
                this.fillFormMagentoCreditCard(cardsType.maestro, cardsNumber.maestro, "");
    ...
    casper.fillFormMagentoCreditCard = function (type, card, cvv) {
